...
const colorClasses = computed(() => {
    ...
    const colorMap = {
        ...
        yellow: 'bg-yellow-400 hover:bg-yellow-300 focus:bg-yellow-300 active:bg-yellow-500 focus:ring-yellow-200 disabled:opacity-50 disabled:cursor-not-allowed',
